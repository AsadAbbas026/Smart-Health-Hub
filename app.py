...
def main():
    ...
    if "page" not in st.session_state:
        if st.session_state.user:
            ...
            # Only use last_page_cookie if it’s NOT 'auth'
            if last_page_cookie and last_page_cookie != "auth":
                st.session_state.page = last_page_cookie
            else:
                st.session_state.page = "patient_dashboard" if role == "patient" else "doctor_dashboard"
        else:
            st.session_state.page = "auth"
